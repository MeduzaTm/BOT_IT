...
def get_text_messages(message):
    ...
    if message.text == "/start":
        ...
        bot.send_message(message.from_user.id, "Это ГороскопБот, введите команду /start для начала")
    else:
        bot.send_message(message.from_user.id, "Некорректная команда, введите /help для справки")
